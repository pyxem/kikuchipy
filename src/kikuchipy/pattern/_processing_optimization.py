...
def plot_pattern_processing_result(
    ...
    :func:`optimize_pattern_processing` result, annotated with the
    image quality and normalized cross-correlation at that stage.
    ...
    ----------
    result
        Dictionary returned by :func:`optimize_pattern_processing`.
    reference
    ...
    ...     s.data, simulated.data
    ... )  # doctest: +SKIP
    >>> fig = kp.pattern.plot_pattern_processing_result(

...
Lambert projection and its use.
"""
...
# %%
# Read the packaged low-resolution nickel master pattern in the stereographic
# projection.
mp_stereo = kp.data.nickel_ebsd_master_pattern_small(projection="stereographic")
print(mp_stereo)

# %%
# Project it to the square Lambert projection.
mp_lam = mp_stereo.as_lambert()
